...
class DataListCP
{
    ...
    function GetPageList($atts,$refObj='',$fields=array())
    {
        ...
        if($this->pageNO != 1)
        {
            if ($prepagenum == 1)
            {
                $prepage .= "<li><a class='prePage' href='".$purl.".html'>&laquo;</a></li> \n";
            }
            else
            {
                $prepage .= "<li><a class='prePage' href='".$purl."_$prepagenum.html'>&laquo;</a></li> \n";
            }
        }
        else
        {
            $indexpage = "<li><a href='#'>&laquo; \n</span></li>";
        }
        if($this->pageNO != $totalpage && $totalpage > 1)
        {
            $nextpage.="<li><a class='nextPage' href='".$purl."_$nextpagenum.html'>&raquo;</a></li> \n";
        }
        else
        {
        ...
        for($j; $j<=$total_list; $j++)
        {
            if ($j == $this->pageNO)
            {
                $listdd .= '<li class="am-active"><a href="#">'.$j.'</a></li>';
            }
            else
            {
                if ($j == 1) {
                    $listdd .= "<li><a href='".$purl.".html'>".$j."</a></li>\n";
                }
                else
                {
                    $listdd .= "<li><a href='".$purl."_$j.html'>".$j."</a></li>\n";
                }
            }
        }
