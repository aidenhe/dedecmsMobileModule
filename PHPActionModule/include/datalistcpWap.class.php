...
class DataListCP
{
    ...
    function GetPageList($atts,$refObj='',$fields=array())
    {
        ...
        if($this->pageNO != 1)
        {
            $prepage .= "<li><a class='prePage' href='".$purl."pageno=$prepagenum'>&laquo;</a></li> \n";
        }
        else
        {
        ...
        {
            $nextpage.="<li><a class='nextPage' href='".$purl."pageno=$nextpagenum'>&raquo;</a></li> \n";
        }
        else
        {
        ...
        {
            $listdd .= $j==$this->pageNO ? '<li class="am-active"><a href="#">'.$j.'</a></li>' : "<li><a href='".$purl."pageno=$j'>".$j."</a></li>\n";
        }
